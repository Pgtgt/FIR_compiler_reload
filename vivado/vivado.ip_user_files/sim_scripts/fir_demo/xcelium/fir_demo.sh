...
#
# Script generated by Vivado on Tue Jan 14 00:08:52 +0900 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fir_demo.sh
...
#
# Usage        : fir_demo.sh
#                fir_demo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_demo.sh [-reset_run]
#                fir_demo.sh [-reset_log]
#                fir_demo.sh [-help]
#
...
#                script (type 'fir_demo.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_11 -libname axi_utils_v2_0_7 -libname fir_compiler_v7_2_20 -libname xil_defaultlib -libname xlconstant_v1_1_8 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_11 axi_utils_v2_0_7 fir_compiler_v7_2_20 xil_defaultlib xlconstant_v1_1_8)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fir_demo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_demo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fir_demo xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fir_demo -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fir_demo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_demo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_demo.sh [-help]\n\
Usage: fir_demo.sh [-step]\n\
Usage: fir_demo.sh [-lib_map_path]\n\
Usage: fir_demo.sh [-reset_run]\n\
Usage: fir_demo.sh [-reset_log]\n\
Usage: fir_demo.sh [-keep_index]\n\
Usage: fir_demo.sh [-noclean_files]\n\n\
