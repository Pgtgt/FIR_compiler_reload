...
design_libs=(xbip_utils_v3_0_11 axi_utils_v2_0_7 fir_compiler_v7_2_20 xil_defaultlib xlconstant_v1_1_8)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fir_demo xil_defaultlib.glbl -o fir_demo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fir_demo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fir_demo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fir_demo_simv.daidir vcs_lib c.obj)
