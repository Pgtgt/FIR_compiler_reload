...
#
# Script generated by Vivado on Mon Jan 13 23:39:48 +0900 2025
...
simulate()
{
  xsim fir_compiler_0 -key {Behavioral:sim_1:Functional:fir_compiler_0} -tclbatch cmd.tcl -protoinst "protoinst_files/fir_demo.protoinst" -log simulate.log
}
